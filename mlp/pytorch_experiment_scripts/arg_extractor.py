...
def get_args():
    ...
    parser.add_argument('--seed', nargs="?", type=int, default=9112018,
    ...
    parser.add_argument('--num_filters', nargs="?", type=str, default=64,
    ...
    parser.add_argument('--pool_size', nargs="?", type=int, default=2,
                        help='size for pool-layer')
    parser.add_argument('--stride', nargs="?", type=int, default=2,
                        help='stride')
    parser.add_argument('--mode', nargs = "?", type = str, default = 'LSTM')
